...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        TimeOnPathData CalculateClosestPointOnPathData (Vector3 worldPoint) {
            ...
            if(oldx <= closestSegmentIndexA && oldy <= closestSegmentIndexB)
            {
                oldx = closestSegmentIndexA;
                oldy = closestSegmentIndexB;
            ...
            return new TimeOnPathData ((int)oldx, (int)oldy, t);
        }
